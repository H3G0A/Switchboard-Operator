...
public class BoardController : MonoBehaviour
{
    ...
    [SerializeField] int _timer = 210;
    [SerializeField] int _roundsToWin = 14;
    ...
    {
        foreach(GameObject pluck in _plucks) {  string label; int[] labelId = CreateLabelId(label = Random.Range(0, 999999).ToString("D6"));
    ...
    private int[] CreateLabelId(string label)
    {
        ...
        int digit1 = int.Parse(label.Substring(0, 1)); int digit2 = int.Parse(label.Substring(1, 1)); int evenAmount = 0; int primeAmount = 0;
    ...
    private IEnumerator TransitionToNextCaller()
    {
        ...
        Debug.Log(_currentCallers[0].pluck + " ---------- " + _currentCallers[1].pluck);
